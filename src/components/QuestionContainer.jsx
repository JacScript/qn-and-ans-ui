...
const QuestionContainer = (props) => {
  ...
  return (
    <div className="bg-[#393939] w-screen h-full">
      <div className="flex justify-between py-[px] px-[20px] text-white max-md:my-4 md:my-6 w-11/12 mx-auto">
        <h1 className="max-md:text-[15px] text-[1.5rem] flex items-center">Top Question</h1>
        <Link
          to={"/Ask"}
          className="bg-[#378ad3] text-[#fff] rounded-[5px]  flex items-center align-middle px-[10px] text-sm"
        >
          Ask Question
        </Link>
      </div>
